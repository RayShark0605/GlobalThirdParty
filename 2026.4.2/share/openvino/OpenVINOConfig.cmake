...
macro(_ov_find_protobuf_frontend_dependency)
    ...
    set(_OV_PROTOBUF_PACKAGE_CONFIG "CONFIG")
    if(_OV_ENABLE_SYSTEM_PROTOBUF)
        _ov_find_dependency(Protobuf 33.4.0 EXACT ${_OV_PROTOBUF_PACKAGE_CONFIG})
    endif()
...
macro(_ov_find_tensorflow_frontend_dependencies)
    ...
    if(_OV_ENABLE_SYSTEM_SNAPPY)
        _ov_find_dependency(Snappy 1.2.2 EXACT)
    endif()
...
macro(_ov_find_onnx_frontend_dependencies)
    set(_OV_ENABLE_SYSTEM_ONNX "1")
    if(_OV_ENABLE_SYSTEM_ONNX)
        _ov_find_dependency(ONNX 1.19.0 EXACT)
    endif()
